...
DDL_STATEMENTS = [
    ...
    """,
    # ecm.folder (uses gen_random_uuid(); harmless if pgcrypto missing as long as you don't insert)
    """
    ...
    with engine.begin() as conn:
        for stmt in DDL_STATEMENTS:
            try:
                ...
                # Don’t abort startup if EXTENSION creation isn’t allowed
                logger.warning("DDL statement failed (continuing): %s | %s", stmt.splitlines()[0][:80], e)
